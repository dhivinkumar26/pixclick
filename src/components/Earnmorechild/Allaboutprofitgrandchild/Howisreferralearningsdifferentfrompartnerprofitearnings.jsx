...
const Howisreferralearningsdifferentfrompartnerprofitearnings = () => {
    ...
    <div className="bg-white p-4 sm:p-8 rounded-xl shadow-lg max-w-7xl mx-auto mt-10">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          How is Referral Earnings different from Partner Profit Earnings?
          </h2>
...
export default Howisreferralearningsdifferentfrompartnerprofitearnings;
