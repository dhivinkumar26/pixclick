...
const Howtofindexclusivedealsontheappdaily = () => {
    ...
    <div className="bg-white p-4 sm:p-8 rounded-xl shadow-lg max-w-7xl mx-auto mt-10">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
         ...
         How To Find Exclusive Deals On The App Daily
          </h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>All the best deals curated on the EarnKaro App for you</li>
...
export default Howtofindexclusivedealsontheappdaily ;
