...
const Allaboutprofit = () => {
  const location = useLocation();

  // ✅ Check if it's a grandchild route
  const isGrandchild = location.pathname !== "/profitshala/all-about-profit";

  const helpData = [
    {
      title: "How to check Profit rates?",
      videoUrl: "https://www.youtube.com/embed/HYJznS2H8Cg?si=yz19iMR1d6Rjs1-E",
      linkTo: "/profitshala/all-about-profit/how-to-check-profit-rates",
    },
    {
      title: "How to make Profit Links?",
      videoUrl: "https://www.youtube.com/embed/wnZ0Crref4A?si=Tkq3JhjEV3F0ZnrF",
      linkTo: "/profitshala/all-about-profit/how-to-make-profit-links",
    },
    {
      title: " How is your Profit tracked?",
      videoUrl: "https://www.youtube.com/embed/_qEBGhVj4wI?si=KTR16vhSwqXV3XHT" , 
      linkTo: "/profitshala/all-about-profit/how-is-your-profit-tracked",
    },
    {
      title: "How to check your earned Profit?",
      videoUrl: "https://www.youtube.com/embed/Fr0irwBLZsk?si=J6y1uhqXj9Ifr2hy",
      linkTo: "/profitshala/all-about-profit/how-to-check-your-earned-profit",
    },
       {
      title: "How to transfer money to your bank account?",
      videoUrl: "https://www.youtube.com/embed/Fr0irwBLZsk?si=J6y1uhqXj9Ifr2hy",
      linkTo: "/profitshala/all-about-profit/how-to-transfer-money-to-your-bank-account",
    },
       {
      title: "How to refer and earn 10% Profit for a lifetime?",
      videoUrl: "https://www.youtube.com/embed/Fr0irwBLZsk?si=J6y1uhqXj9Ifr2hy",
      linkTo: "/profitshala/all-about-profit/how-to-refer-and-earn-profit-for-a-lifetime",
    },
       {
      title: "How is Referral Earnings different from Partner Profit Earnings?",
      videoUrl: "https://www.youtube.com/embed/Fr0irwBLZsk?si=J6y1uhqXj9Ifr2hy",
      linkTo: "/profitshala/all-about-profit/how-is-referral-earnings-different-from-partner-profit-earnings",
    },
  ];
