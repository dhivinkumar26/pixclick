...
const Changelanguageonearnkaro = () => {
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            How to change language on EarnKaro?
          </h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>EarnKaro is available in 9 major languages spoken across India.</li>
            <li>You have to simply click on the ‘Profile’ icon</li>
            <li>Select ’Choose Language’</li>
            <li>Select your preferred language and press Continue</li>
            <li>Relaunch the app and you’re ready to go</li>
          </ul>
        </div>
...
export default Changelanguageonearnkaro;
