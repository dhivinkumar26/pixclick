    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <section className="px-6">
        ...
        <div className="text-center mt-10">
          ...
          <Link to="/login"><button className="bg-yellow-400 text-black px-12 py-2 rounded-lg text-md font-bold">Login</button></Link><br />
          <Link to="/terms-conditions"><button className="text-sm mt-8 mb-8"><u>Terms & Conditions</u></button></Link>
        </div>
      </section>
    </div>
  );
