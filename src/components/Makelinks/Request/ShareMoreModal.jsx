...
import EarningsSection from "./../Myearnings/Earning"; // ✅ import your actual earnings component

export default function EarningsWithShareModal() {
  const [showModal, setShowModal] = useState(true); // Modal shows initially

  return (
    <div className="relative min-h-screen bg-gray-50">
      {/* ✅ Earnings Section Component in Background */}
      <EarningsSection />
