  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-start bg-gray-50 p-4">
      <div className="w-full max-w-2xl">
        ...
        {/* Page Title */}
        <h2 className="text-2xl font-bold mb-4 shadow bg-white rounded-lg p-3">REPORTS</h2>
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
            <div className="flex items-center gap-2 text-orange-500 font-semibold p-2 outline outline-gray-300 rounded-md">
              ⏳ Pending <span className="text-black font-medium">₹30</span>
            </div>
            <div className="flex items-center gap-2 text-green-600 font-semibold p-2 outline outline-gray-300 rounded-md">
              ✅ Confirmed <span className="text-black font-medium">₹0</span>
            </div>
            <div className="flex items-center gap-2 text-blue-500 font-semibold p-2 outline outline-gray-300 rounded-md">
              💰 Paid <span className="text-black font-medium">₹0</span>
            </div>
            <div className="flex items-center gap-2 text-purple-600 font-semibold p-2 outline outline-gray-300 rounded-md">
              📤 Requested <span className="text-black font-medium">₹0</span>
            </div>
            <div className="flex items-center gap-2 text-red-500 font-semibold p-2 outline outline-gray-300 rounded-md">
              ❌ Cancelled <span className="text-black font-medium">₹0</span>
            </div>
          </div>
 
          <div className="text-sm text-blue-800 mt-3 underline cursor-pointer">What’s this?</div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold flex items-center gap-2 text-green-700">
              <span classname="bg-green-700 rounded-full">₹</span> Performance Breakdown Overview
            </h3>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold flex items-center gap-2 text-green-700">
             <span classname="bg-green-700 rounded-full"> 📈 </span> Performance by All Brands
            </h3>
            <select className="border rounded px-2 py-1 text-sm text-gray-300">
              <option>Filter by</option>
            </select>
          </div>
